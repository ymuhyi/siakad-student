		...
		<form action="" method="GET" id="frm_rekap">
			...
			<label>Program Studi</label>
				...
				<label>Semester</label>
					<input type="text" name="semester" maxlength="1" class="required">
			<br><br><div>
		...
		<div class='well'>
			...
			<table id='example' class='display'>
				<thead>
					<tr bgcolor='#B7D577'>
						<th width='5'>No.</th>
						<th align='center' width='70'>NIM</th>
						<th align='center' width='270'>Nama Mahasiswa</th>
						<th align='center' width='70'>IP</th>
			...
			while ($data_rekap = $db->database_fetch_array($sql_data)){
				...
				echo "<tr>
						<td>$i</td>
						<td align='center'>$data_rekap[NIM]</td>
			...
			echo "</tbody></table><br>";
		echo "</div>";
	echo "<h4><a target='_blank' href='modul/mod_nilai/export_rekap.php?prodi=$_GET[prodi]&kelas=$_GET[kelas]&semester=$_GET[semester]'>Export Rekap</a></h4>";
	break;
