...
switch($_GET['act']){
	...
	";
	echo "<a target='_blank' href='modul/mod_nilai/export_transkip.php?id=$data_mhs[id_mhs]'><button type='button' class='btn btn-primary'>Export Transkip</button></a>";
	break;
}
?>